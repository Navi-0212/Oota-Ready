...
import { Star, MapPin, Utensils, DollarSign, TrendingUp, Sparkles, BookOpen } from 'lucide-react';
        ...
        <div className="p-6">
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              className="w-full mt-4 py-3 px-6 rounded-xl font-semibold transition-all flex items-center justify-center space-x-2 shadow-md"
              style={{ 
